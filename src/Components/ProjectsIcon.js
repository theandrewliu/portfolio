...
import { changeProjectsActive, changeProjectsClosed, changeProjectsOnTaskbar, setProjectsOrder, setProjectsZ, changeAllActiveToFalse, incrementGlobalZ } from "../Redux/homeSlice"
...
const ProjectsIcon = () => {
    ...
    <Draggable handle="#icon" onStart={onStart} onStop={onStop} scale={0.75}>
        <div className="pb-3 justify-center flex z-[5]" onTouchStart={(event)=>{event.stopPropagation();ProjectsOnClick()}}>
